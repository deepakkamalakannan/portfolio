...
import { Card, CardContent } from "@/app/skills/card";
import { Badge } from "@/app/skills/badge";
import IconCloudDemo from "@/app/skills/globe";
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Source True", icon: <SiSourcetree className="w-4 h-4 text-[#646CFF]" /> },
      ],
    },
    // {
    //   icon: Paintbrush,
